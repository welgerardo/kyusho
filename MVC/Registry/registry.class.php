 ...
 *
 */
require_once 'objects/MasterConfig.php';
...
class MGPDINAMIC {
    ...
    private function __construct() {
        ...
        //$this->lang = (isset($_GET['lang']) && in_array($_GET['lang'], $GLOBALS['LANGPAGES'])) ? $_GET['lang'] : $GLOBALS['LANGPAGES'][0];
         ...
         require_once "objects/SLang" . strtoupper($this->lang) . ".php";
    }
    ...
    private function init(){
        ...
        $this->storeObject("GestImages", "g_images" );
        $this->storeObject("Core", "core" );
        $this->storeObject("Page", "page" );
        $this->storeObject("Logex", "logex" );
        
        $this->loginStatus = Logex::checkClientLogin();
    }
    ...
    /**
     *
     * @return string - código do idioma página
     */
