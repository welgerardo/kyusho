...
$CLIENTE = NULL;
$NOW = date("YmdHis");
$LANGPAGES = array("pt");//ISO 639-1 Language Codes
$LANGFLAGS = array("pt"=>"imagens/flags/Portugal.png","en"=>"imagens/flags/United_Kingdom.png","fr"=>"imagens/flags/France.png","de"=>"imagens/flags/Germany.png");

$FLAGSMODE= array("ADD","ADDK","UPDATE","CLONE","SAVE","DELETE","DELETEK","CHANGE","CHANGEK","FOLDER","MESSAGES","OPTIONS","FILE","FILEOP","INFO","SUBMENU","NOTES","GALLERYF","GALLERY","SEARCH","ORDER","SAVEORDER","MODULE","FORNEWS","FORMODULE","GROUP","SEND","SENDK","PASS","READ","CLOSEGROUP","ITENSTAT","STATS","SPECIALP","OTHP","RELATIONS","GALLERYM");
...
define('_US', 'root');
define('_PS', '');
define('_SOMEK',md5("masterplf"._RURL));
...
define('_MFILE','D:\xampp\htdocs\petitamour.pt\DinamicGestC\EPKMaster.json');

define('_IMAGEPATH', _RPATH.'galeria\\');
define('_IMAGESITEPATH', _RPATH.'client_img\\');
