...
class Anti
{
    ...
    {
        $a = preg_match("#([0-9]{1,2})(\/|-)([0-9]{1,2})(\/|-)([0-9]{4})#", $string,$match);
        if (!$a)
        {
            return FALSE;
        }
        ...
        {
            if($match[1]<32 && $match[3]<13 && ($match[5]>1915 && $match[5]< strftime("%Y") )){
                return $string;
            }
            else{
                return FALSE;
    ...
    public function validate_date($datex)
    {
        ...
        if (preg_match("#([0-9]{1,2})(\/|-)([0-9]{1,2})(\/|-)([0-9]{4})#", $datex, $matches))
        {

            if (checkdate($matches[3], $matches[1], $matches[5]))
            {
