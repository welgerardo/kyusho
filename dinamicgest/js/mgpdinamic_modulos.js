...
BigBang = {
    ob: "",
    mURL: "http://localhost/kyusho/dinamicgest/DinamicGestM/",
    saveon: function(t) {
...
Eventix = {
    ...
    starter: function() {
        ...
        var porti = new imgallery_width_captions();
        porti.nameImage = "portfolio_image";
        porti.nameSubtitles = "portfolio_captions";
        porti.lang = ["pt","en"];
        porti.init("midia_images");
...
MakeNewsletrix = {
    ...
    nome: null,
    icon: null,
    modulos: {"noticias":{"module":Newsix,"type":"newsl","mode":"FORNEWS","flag":null},"cursos":{"module":Workix,"mode":"FORNEWS","type":"newsl","flag":null},"eventos":{"module":Eventix,"mode":"FORNEWS","type":"newsl","flag":null}},
    search_on: false,
    search_fields: false,
    folders_on: Folders.open_folders,
    subfolders_off: false,
...
OP = {
    ...
    icon: null,
    submenu_on: NavMenu.sub_menu,
    submenu_options: {"Home page": Homix.bang, "Cursos":Scursix.bang, "Eventos":Seventix.bang, "Quem somos":Ssomix.bang, "Noticias":Snoticix.bang, "Recrutamento": Recrutix.bang, "Privacidade": Privatix.bang},
    start_on: Loader.load,
    bang: function(event) {
        if (BigBang.saveon()) {
            if (BigBang.sairSemSalvar())
...
FirstBang = {
    ...
    modulos: [OP, Workix, Eventix, Newsix, Empresix, Imagix, Contactix,  Mensagix, Newsletrix,  Redix],
    init: function() {
    	window.scrollTo(0,0);
